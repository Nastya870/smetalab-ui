        ...
        <Dialog>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Заполните основные данные объекта для создания сметы и начала работы.
                    </DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input id="name" placeholder="Например: Коттедж в Барвихе" />
                    </div>

                    {/* 1. Заказчик - с выпадающим списком */}
                    <div className="grid gap-2">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Input id="contractor" defaultValue="SMETA LAB" />
                    </div>
